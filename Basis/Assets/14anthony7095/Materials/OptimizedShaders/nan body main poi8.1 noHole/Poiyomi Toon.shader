Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/d55b2f2b378ed3e4bb0be0109c0c84ec"
{
	Properties
	{
		...
		_Saturation_nanbodymainpoi82E1noHole ("Saturation", Range(-1, 10)) = 0
		...
		[DoNotLock]_LightingCap_nanbodymainpoi82E1noHole ("Max Brightness--{condition_showS:(_LightingCapEnabled==1)}", Range(0, 10)) = 1
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _LightingCap_nanbodymainpoi82E1noHole;
			...
			float _Saturation_nanbodymainpoi82E1noHole;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				poiLight.occlusion = min(min(min(lerp(1, AOMaps.r, 1.0), lerp(1, AOMaps.g, 1.0)), lerp(1, AOMaps.b, 1.0)), lerp(1, AOMaps.a, 1.0));
				#else
				...
				#ifndef POI_PASS_ADD
				poiLight.detailShadow = lerp(1, DetailShadows.r, 1.0) * lerp(1, DetailShadows.g, 1.0) * lerp(1, DetailShadows.b, 1.0) * lerp(1, DetailShadows.a, 0.0);
				#else
				...
				{
					poiLight.directColor = min(poiLight.directColor, _LightingCap_nanbodymainpoi82E1noHole);
					poiLight.indirectColor = min(poiLight.indirectColor, _LightingCap_nanbodymainpoi82E1noHole);
				}
				if (0.0)
				{
				...
				poiFragData.baseColor *= poiThemeColor(poiMods, float4(1,1,1,0).rgb, 0.0);
				...
				poiFragData.baseColor = lerp(poiFragData.baseColor, dot(poiFragData.baseColor, float3(0.3, 0.59, 0.11)), - (_Saturation_nanbodymainpoi82E1noHole) * hueShiftAlpha.b);
