Shader "Hidden/Locked/.poiyomi/Poiyomi Toon/9d3cc5fa93f7ca8409735f7362375e8e"
{
	Properties
	{
		...
		[DoNotLock]_LightingCap_nanextraspoi82E1Transparent ("Max Brightness--{condition_showS:(_LightingCapEnabled==1)}", Range(0, 10)) = 1
		...
		_EmissionStrength_nanextraspoi82E1Transparent ("Emission Strength", Range(0, 20)) = 0
 ...
 #define OPTIMIZER_ENABLED 
			...
			float _LightingCap_nanextraspoi82E1Transparent;
			...
			float _EmissionStrength_nanextraspoi82E1Transparent;
			...
			float3 applyEmission(inout PoiFragData poiFragData, in PoiMesh poiMesh, in PoiLight poiLight, in PoiCam poiCam, in PoiMods poiMods)
			{
				...
				float emissionStrength0 = _EmissionStrength_nanextraspoi82E1Transparent;
			...
			float4 frag(VertexOut i, uint facing : SV_IsFrontFace) : SV_Target
			{
				...
				{
					poiLight.directColor = min(poiLight.directColor, _LightingCap_nanextraspoi82E1Transparent);
					poiLight.indirectColor = min(poiLight.indirectColor, _LightingCap_nanextraspoi82E1Transparent);
				}
				if (0.0)
				{
